...
class _InActiveUsersScreenState extends State<InActiveUsersScreen> {
  ...
  //   QuerySnapshot querySnapshot = await usersRef.where('status', isEqualTo: 'Inactive').get();
  //   setState(() {
  ...
  Future<List<DocumentSnapshot>> _getActiveUsers() async {
    CollectionReference usersRef = FirebaseFirestore.instance.collection('User');
    QuerySnapshot querySnapshot = await usersRef.where('status', isEqualTo: 'Passive').get();
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          toolbarHeight: 50,
          elevation: 0,
          title:   Text('InActive Users',style: TextStyle(color: allHeadingPrimeColor),),
          leading: IconButton(
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(color: allHeadingPrimeColor, onPressed: () {searchController.clear();
                  _getActiveUsers();
                  },
